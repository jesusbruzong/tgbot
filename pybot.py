...
def send_conditions(message):
    #Da los precios del servicio al usuario del bot
    bot.reply_to(message, ("Por determinar"))
...
#Botones
markup = types.ReplyKeyboardMarkup(one_time_keyboard=False, input_field_placeholder= "Pulsa un botón")
boton_op_1 = types.KeyboardButton('/ayuda')
boton_op_2 = types.KeyboardButton('/demo')
boton_op_3 = types.KeyboardButton('/pagos')
...
#Respuesta a los mensajes (no comandos)
